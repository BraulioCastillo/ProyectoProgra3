...
namespace ProyectoFinal {
    ...
    public partial class DataSetFACTURAS : global::System.Data.DataSet {
        ...
        public partial class FacturaDataTable : global::System.Data.TypedTableBase<FacturaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FacturaRow AddFacturaRow(System.DateTime fecha, decimal monto, int ID_usuario) {
...
namespace ProyectoFinal.DataSetFACTURASTableAdapters {
    ...
    public partial class FacturaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Factura] WHERE (([ID] = @Original_ID) AND ([fecha] = @Original" +
                "_fecha) AND ([monto] = @Original_monto) AND ([ID_usuario] = @Original_ID_usuario" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Factura] ([fecha], [monto], [ID_usuario]) VALUES (@fecha, @mon" +
                "to, @ID_usuario);\r\nSELECT ID, fecha, monto, ID_usuario FROM Factura WHERE (ID = " +
                "SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Factura] SET [fecha] = @fecha, [monto] = @monto, [ID_usuario] = @ID_usuario WHERE (([ID] = @Original_ID) AND ([fecha] = @Original_fecha) AND ([monto] = @Original_monto) AND ([ID_usuario] = @Original_ID_usuario));
SELECT ID, fecha, monto, ID_usuario FROM Factura WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=YASHIN-PC\\SQLEXPRESS;Initial Catalog=ProyectoFinal;Integrated Securit" +
                "y=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, fecha, monto, ID_usuario FROM dbo.Factura";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ID, fecha, monto, ID_usuario FROM dbo.Factura";
        ...
        public virtual int Fill(DataSetFACTURAS.FacturaDataTable dataTable) {
        ...
        public virtual DataSetFACTURAS.FacturaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetFACTURAS.FacturaDataTable dataTable = new DataSetFACTURAS.FacturaDataTable();
        ...
        public virtual int FillByFACTURA(DataSetFACTURAS.FacturaDataTable dataTable) {
        ...
        public virtual DataSetFACTURAS.FacturaDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSetFACTURAS.FacturaDataTable dataTable = new DataSetFACTURAS.FacturaDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetFACTURAS.FacturaDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, System.DateTime Original_fecha, decimal Original_monto, int Original_ID_usuario) {
        ...
        public virtual int Insert(System.DateTime fecha, decimal monto, int ID_usuario) {
        ...
        public virtual int Update(System.DateTime fecha, decimal monto, int ID_usuario, int Original_ID, System.DateTime Original_fecha, decimal Original_monto, int Original_ID_usuario, int ID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime fecha, decimal monto, int ID_usuario, int Original_ID, System.DateTime Original_fecha, decimal Original_monto, int Original_ID_usuario) {
            return this.Update(fecha, monto, ID_usuario, Original_ID, Original_fecha, Original_monto, Original_ID_usuario, Original_ID);
        }
    }
